<template>
  <div class="fixed bottom-2 right-2 text-sm font-inter text-gray-500 flex items-center gap-2">
    ...
    <span>
      ...
      <span
        :class="{
          ...
          'text-yellow-600 bg-yellow-50 px-1.5 py-0.5 rounded': site?.plan === 'PREMIUM',
          'text-orange-600 bg-orange-50 px-1.5 py-0.5 rounded font-bold': site?.plan === 'CUSTOM',
          'font-semibold': true,
        }"
      >
